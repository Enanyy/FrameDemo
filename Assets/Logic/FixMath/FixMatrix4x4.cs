...
namespace Fix
{
    ...
    public struct FixMatrix4x4
    {
        ...
        public FixMatrix4x4(fixed64 m11, fixed64 m12, fixed64 m13, fixed64 m14,
        ...
        public static void Inverse(ref FixMatrix4x4 matrix, out FixMatrix4x4 result)
        {
            ...
            if (det == fixed64.Zero)
            {
                ...
                result.M14 = fixed64.PositiveInfinity;
                result.M21 = fixed64.PositiveInfinity;
                result.M22 = fixed64.PositiveInfinity;
                result.M23 = fixed64.PositiveInfinity;
                result.M24 = fixed64.PositiveInfinity;
                result.M31 = fixed64.PositiveInfinity;
                result.M32 = fixed64.PositiveInfinity;
                result.M33 = fixed64.PositiveInfinity;
                result.M34 = fixed64.PositiveInfinity;
                result.M41 = fixed64.PositiveInfinity;
                result.M42 = fixed64.PositiveInfinity;
                result.M43 = fixed64.PositiveInfinity;
                result.M44 = fixed64.PositiveInfinity;
        ...
        public static FixMatrix4x4 Multiply(FixMatrix4x4 matrix1, fixed64 scaleFactor)
        {
            FixMatrix4x4 result;
        ...
        public static void Multiply(ref FixMatrix4x4 matrix1, fixed64 scaleFactor, out FixMatrix4x4 result)
        {
        ...
        {
            FixMatrix4x4 result;
            FixMatrix4x4.Multiply(ref value2, -fixed64.One, out value2);
            FixMatrix4x4.Add(ref value1, ref value2, out result);
            return result;
        }
        ...
        public static FixMatrix4x4 Translate(fixed64 xPosition, fixed64 yPosition, fixed64 zPosition)
        {
            FixMatrix4x4 result;

            result.M11 = fixed64.One;  result.M12 = fixed64.Zero; result.M13 = fixed64.Zero; result.M14 = xPosition;
            result.M21 = fixed64.Zero; result.M22 = fixed64.One;  result.M23 = fixed64.Zero; result.M24 = yPosition;
            result.M31 = fixed64.Zero; result.M32 = fixed64.Zero; result.M33 = fixed64.One;  result.M34 = zPosition;
            result.M41 = fixed64.Zero; result.M42 = fixed64.Zero; result.M43 = fixed64.Zero; result.M44 = fixed64.One;
        ...
        public static FixMatrix4x4 Scale(fixed64 xScale, fixed64 yScale, fixed64 zScale)
        {
            FixMatrix4x4 result;

            result.M11 = xScale;  result.M12 = fixed64.Zero; result.M13 = fixed64.Zero; result.M14 = fixed64.Zero;
            result.M21 = fixed64.Zero; result.M22 = yScale;  result.M23 = fixed64.Zero; result.M24 = fixed64.Zero;
            result.M31 = fixed64.Zero; result.M32 = fixed64.Zero; result.M33 = zScale;  result.M34 = fixed64.Zero;
            result.M41 = fixed64.Zero; result.M42 = fixed64.Zero; result.M43 = fixed64.Zero; result.M44 = fixed64.One;
        ...
        /// <returns>The scaling matrix.</returns>
        public static FixMatrix4x4 Scale(fixed64 xScale, fixed64 yScale, fixed64 zScale, FixVector3 centerPoint)
        {
            FixMatrix4x4 result;
            ...
            result.M21 = fixed64.Zero; result.M22 = yScale;  result.M23 = fixed64.Zero; result.M24 = fixed64.Zero;
            result.M31 = fixed64.Zero; result.M32 = fixed64.Zero; result.M33 = zScale;  result.M34 = fixed64.Zero;
            result.M41 = tx;      result.M42 = ty;      result.M43 = tz;      result.M44 = fixed64.One;
        ...
        /// <returns>The scaling matrix.</returns>
        public static FixMatrix4x4 Scale(fixed64 scale)
        {
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>The scaling matrix.</returns>
        public static FixMatrix4x4 Scale(fixed64 scale, FixVector3 centerPoint)
        {
        ...
        public static FixMatrix4x4 RotateX(fixed64 radians)
        {
            FixMatrix4x4 result;

            fixed64 c = FixMath.Cos(radians);
            fixed64 s = FixMath.Sin(radians);
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>The rotation matrix.</returns>
        public static FixMatrix4x4 RotateX(fixed64 radians, FixVector3 centerPoint)
        {
            FixMatrix4x4 result;
        ...
        /// <returns>The rotation matrix.</returns>
        public static FixMatrix4x4 RotateY(fixed64 radians)
        {
            FixMatrix4x4 result;
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>The rotation matrix.</returns>
        public static FixMatrix4x4 RotateY(fixed64 radians, FixVector3 centerPoint)
        {
            FixMatrix4x4 result;
        ...
        /// <returns>The rotation matrix.</returns>
        public static FixMatrix4x4 RotateZ(fixed64 radians)
        {
            FixMatrix4x4 result;
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>The rotation matrix.</returns>
        public static FixMatrix4x4 RotateZ(fixed64 radians, FixVector3 centerPoint)
        {
            FixMatrix4x4 result;
        ...
        public static void AxisAngle(ref FixVector3 axis, fixed64 angle, out FixMatrix4x4 result)
        {
            // a: angle
            ...
            fixed64 sa = FixMath.Sin(angle), ca = FixMath.Cos(angle);
        ...
        public static FixMatrix4x4 AngleAxis(fixed64 angle, FixVector3 axis)
        {
            FixMatrix4x4 result;
