    ...
    public struct FixMatrix3x3
    {
        ...
        public FixVector3 eulerAngles {
            get {
                ...
                result.x = FixMath.Atan2(M32, M33) * fixed64.Rad2Deg;
                result.y = FixMath.Atan2(-M31, FixMath.Sqrt(M32 * M32 + M33 * M33)) * fixed64.Rad2Deg;
                result.z = FixMath.Atan2(M21, M11) * fixed64.Rad2Deg;

                return result * -1;
            }
        }

        public static FixMatrix3x3 CreateFromYawPitchRoll(fixed64 yaw, fixed64 pitch, fixed64 roll)
        {
            FixMatrix3x3 matrix;
        ...
        public static FixMatrix3x3 CreateRotationX(fixed64 radians)
        {
            FixMatrix3x3 matrix;
        ...
        public static void CreateRotationX(fixed64 radians, out FixMatrix3x3 result)
        {
            fixed64 num2 = fixed64.Cos(radians);
            fixed64 num = fixed64.Sin(radians);
        ...
        public static FixMatrix3x3 CreateRotationY(fixed64 radians)
        {
            FixMatrix3x3 matrix;
            fixed64 num2 = fixed64.Cos(radians);
            fixed64 num = fixed64.Sin(radians);
        ...
        public static void CreateRotationY(fixed64 radians, out FixMatrix3x3 result)
        {
            fixed64 num2 = fixed64.Cos(radians);
            fixed64 num = fixed64.Sin(radians);
            result.M11 = num2;
        ...
        public static FixMatrix3x3 CreateRotationZ(fixed64 radians)
        {
            FixMatrix3x3 matrix;
            fixed64 num2 = fixed64.Cos(radians);
            fixed64 num = fixed64.Sin(radians);
        ...
        public static void CreateRotationZ(fixed64 radians, out FixMatrix3x3 result)
        {
            fixed64 num2 = fixed64.Cos(radians);
            fixed64 num = fixed64.Sin(radians);
            result.M11 = num2;
        ...
        #region public JMatrix(fixed64 m11, fixed64 m12, fixed64 m13, fixed64 m21, fixed64 m22, fixed64 m23,fixed64 m31, fixed64 m32, fixed64 m33)
        public FixMatrix3x3(fixed64 m11, fixed64 m12, fixed64 m13, fixed64 m21, fixed64 m22, fixed64 m23,fixed64 m31, fixed64 m32, fixed64 m33)
        {
            this.M11 = m11;
            this.M12 = m12;
            this.M13 = m13;
        ...
        #region public fixed64 Determinant()
        ...
        #region public static JMatrix Multiply(JMatrix matrix1, fixed64 scaleFactor)
        public static FixMatrix3x3 Multiply(FixMatrix3x3 matrix1, fixed64 scaleFactor)
        {
            FixMatrix3x3 result;
        ...
        public static void Multiply(ref FixMatrix3x3 matrix1, fixed64 scaleFactor, out FixMatrix3x3 result)
        {
        ...
        public static FixMatrix3x3 operator -(FixMatrix3x3 value1, FixMatrix3x3 value2)
        {
            FixMatrix3x3 result; FixMatrix3x3.Multiply(ref value2, -fixed64.One, out value2);
        ...
        #region public static void CreateFromAxisAngle(ref JVector axis, fixed64 angle, out JMatrix result)
        public static void CreateFromAxisAngle(ref FixVector3 axis, fixed64 angle, out FixMatrix3x3 result)
        {
            fixed64 x = axis.x;
            fixed64 y = axis.y;
            fixed64 z = axis.z;
        ...
        public static FixMatrix3x3 AngleAxis(fixed64 angle, FixVector3 axis)
        {
