...
namespace Fix
{
    ...
    public struct FixVector4
    {
        ...
        static FixVector4()
        {
            ...
            MinValue = new FixVector4(fixed64.MinValue);
            MaxValue = new FixVector4(fixed64.MaxValue);
            InternalZero = zero;
        }
        #endregion
        ...
        {
            return new FixVector4(fixed64.Abs(other.x), fixed64.Abs(other.y), fixed64.Abs(other.z), fixed64.Abs(other.z));
        }
        ...
        public static FixVector4 ClampMagnitude(FixVector4 vector, fixed64 maxLength)
        {
        ...
        public FixVector4(fixed64 x, fixed64 y, fixed64 z, fixed64 w)
        {
            this.x = x;
            this.y = y;
            this.z = z;
        ...
        public FixVector4(fixed64 xyzw)
        {
            this.x = xyzw;
            this.y = xyzw;
            this.z = xyzw;
        ...
        public static FixVector4 Lerp(FixVector4 from, FixVector4 to, fixed64 percent)
        {
        ...
        public static fixed64 Distance(FixVector4 v1, FixVector4 v2)
        {
        ...
        public static fixed64 Dot(FixVector4 vector1, FixVector4 vector2)
        {
        ...
        /// <param name="vector2">The second vector.</param>
        /// <returns>Returns the dot product of both vectors.</returns>
        public static fixed64 Dot(ref FixVector4 vector1, ref FixVector4 vector2)
        {
        ...
        public static FixVector4 Divide(FixVector4 value1, fixed64 scaleFactor)
        {
            FixVector4 result;
        ...
        public static void Divide(ref FixVector4 value1, fixed64 scaleFactor, out FixVector4 result)
        {
        ...
        public static FixVector4 Multiply(FixVector4 value1, fixed64 scaleFactor)
        {
            FixVector4 result;
        ...
        public static void Multiply(ref FixVector4 value1, fixed64 scaleFactor, out FixVector4 result)
        {
            result.x = value1.x * scaleFactor;
            result.y = value1.y * scaleFactor;
            result.z = value1.z * scaleFactor;
        ...
        public static fixed64 operator *(FixVector4 value1, FixVector4 value2)
        {
        ...
        public static FixVector4 operator *(FixVector4 value1, fixed64 value2)
        {
            FixVector4 result;
        ...
        public static FixVector4 operator *(fixed64 value1, FixVector4 value2)
        {
            FixVector4 result;
