...
namespace Fix
{
    ...
    public class FixRandom {
        ...
        /**
         *  @brief Returns a {@link fixed64} between a min value [inclusive] and a max value [inclusive].
         **/
         ...
         *  @brief Returns a {@link fixed64} between a min value [inclusive] and a max value [inclusive].
         **/
        public static fixed64 Range(float minValue, float maxValue) {
            return instance.Next(minValue, maxValue);
        }

        /**
         *  @brief Returns a {@link fixed64} between 0.0 [inclusive] and 1.0 [inclusive].
         **/
        public fixed64 NextFP() {
            return ((fixed64) Next()) / (MaxRandomInt);
        }

        /**
         *  @brief Returns a {@link fixed64} between 0.0 [inclusive] and 1.0 [inclusive].
         **/
        public static fixed64 value {
            get {
        ...
        fixed64 genrand_FP() {
            return (fixed64)genrand_int32() * (fixed64.One / (fixed64)4294967295);
        }
